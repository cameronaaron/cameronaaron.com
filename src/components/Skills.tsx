      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-bold mb-6 text-gray-900">Domain Expertise</h3>
            <div className="grid grid-cols-2 gap-4">
              {skills.domains.map((domain, index) => (
                <Card key={index} delay={index * 0.1} gradient hover>
                  <p className="text-gray-700 font-medium text-center">{domain}</p>
                </Card>
              ))}
            </div>

            {/* Certifications */}
            <h3 className="text-2xl font-bold mt-12 mb-6 text-gray-900">Certifications</h3>
