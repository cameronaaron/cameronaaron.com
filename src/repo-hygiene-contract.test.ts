...
const EXPECTED_ROOT_FILES = [
  '.env.example',
  // Machine-generated by `next dev` (agentRules). Tracked deliberately: the
  // generator appends its block to AGENTS.md when it exists and to the
  // hand-written CLAUDE.md when it doesn't, so keeping this file is what stops
  // every `next dev` from dirtying CLAUDE.md. Not linted — see
  // .markdownlint-cli2.jsonc's ignores.
  'AGENTS.md',
  '.gitignore',
